...
import { Settings as SettingsIcon, User, Lock, Database as DatabaseIcon, SaveIcon, RefreshCw, CheckCircle } from "lucide-react";
...
const SettingsPage = () => {
  ...
  const saveSettings = (section) => {
    ...
    // Simuler une sauvegarde avec un délai
    setTimeout(() => {
  ...
  const getTabName = (tab) => {
    switch(tab) {
      ...
      case "tariffs": return "de tarification";
  ...
  const resetSettings = (section) => {
    // Afficher une confirmation pour éviter les réinitialisations accidentelles
  ...
  // Just update the CardFooter sections to add loading state to save buttons
  const renderFooterButtons = (section) => (
    <CardFooter className="flex justify-between">
      <Button 
        variant="outline" 
        onClick={() => resetSettings(section)}
        disabled={isSaving}
      >
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="tariffs">Tarification</TabsTrigger>
        ...
        <TabsContent value="data" className="space-y-4">
          ...
          <Card>
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button onClick={() => saveSettings("data")}>
                <SaveIcon className="h-4 w-4 mr-2" />
                Enregistrer les modifications
              </Button>
            </CardFooter>
        ...
        <TabsContent value="tariffs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configurez les options par défaut pour la tarification
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
